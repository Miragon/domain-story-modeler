...
class EgonClient {
  ...
  static async create(config, additionalModules = [], ports) {
    ...
    const { DiagramJsModelerAdapter } = await import("./DiagramJsModelerAdapter-CYU-RubE.js");
    const { DiagramJsIconAdapter } = await import("./DiagramJsIconAdapter-C9SQOiiI.js");
...
let DomainStoryContextPadProvider$1 = (_k = class {
  ...
  getSelectedBusinessObject(event2) {
    var _a2, _b2;
    (_a2 = this.selectedElement) == null ? void 0 : _a2.businessObject.pickedColor;
    return {
...
//# sourceMappingURL=index-SwmAn_G9.js.map
