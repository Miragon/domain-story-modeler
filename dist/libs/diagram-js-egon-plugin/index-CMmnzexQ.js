...
class EgonClient {
  ...
  static async create(config, additionalModules = [], ports) {
    ...
    const { DiagramJsModelerAdapter } = await import("./DiagramJsModelerAdapter-CA7NjFiJ.js");
    const { DiagramJsIconAdapter } = await import("./DiagramJsIconAdapter-DLaq2S1Q.js");
...
//# sourceMappingURL=index-CMmnzexQ.js.map
