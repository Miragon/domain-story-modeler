...
class EgonClient {
  ...
  static async create(config, additionalModules = [], ports) {
    ...
    const { DiagramJsModelerAdapter } = await import("./DiagramJsModelerAdapter-pyLsA4jI.js");
    const { DiagramJsIconAdapter } = await import("./DiagramJsIconAdapter-BgNMTgzG.js");
...
let DomainStoryContextPadProvider$1 = (_k = class {
  ...
  executeCommandStack(event2) {
    this.getSelectedBusinessObject(event2);
    this.dirtyFlagService.makeDirty();
  }
  getSelectedBusinessObject(event2) {
    var _a2;
    return {
      businessObject: (_a2 = this.selectedElement) == null ? void 0 : _a2.businessObject,
      // newColor: newColor,
...
//# sourceMappingURL=index-CwSJfhbD.js.map
