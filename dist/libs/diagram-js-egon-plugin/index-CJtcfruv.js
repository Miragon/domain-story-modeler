...
class EgonClient {
  ...
  static async create(config, additionalModules = [], ports) {
    ...
    const { DiagramJsModelerAdapter } = await import("./DiagramJsModelerAdapter-D80BzUbK.js");
    const { DiagramJsIconAdapter } = await import("./DiagramJsIconAdapter-Cx0MVnq9.js");
...
//# sourceMappingURL=index-CJtcfruv.js.map
