...
import { BehaviorSubject as Ru } from "rxjs";
import ku from "ids";
import Pu from "diagram-js-direct-editing";
class Zi {
  constructor(e, n, i) {
  ...
  static async create(e, n = [], i) {
    ...
    const { DiagramJsModelerAdapter: r } = await import("./DiagramJsModelerAdapter-DNp7gQc-.js"), { DiagramJsIconAdapter: o } = await import("./DiagramJsIconAdapter-BKsBcyq5.js"), s = new r(
      e.container,
      e.width ?? "100%",
      e.height ?? "100%",
      n
...
var ka = "is not a registered action", Mu = "is already registered";
function Re(t, e) {
  this._actions = {};
  var n = this;
...
var Iu = ["c", "C"], ju = ["v", "V"], Du = ["y", "Y"], Ma = ["z", "Z"];
function Lu(t) {
...
function Wu(t) {
  return Ee(t) && (ue(Du, t) || ue(Ma, t) && $r(t));
}
var mi = "keyboard.keydown", zu = "keyboard.keyup", Uu = 1e3, Ia = "Keyboard binding is now implicit; explicit binding to an element got removed. For more information, see https://github.com/bpmn-io/diagram-js/issues/661";
function te(t, e) {
  var n = this;
...
te.prototype.addListener = function(t, e, n) {
  Z(t) && (n = e, e = t, t = Uu), this._eventBus.on(n || mi, t, e);
};
te.prototype.removeListener = function(t, e) {
  this._eventBus.off(e || mi, t);
};
te.prototype.hasModifier = Lu;
...
function Vr(t, e) {
  var n = this;
  t.on("editorActions.init", Fu, function(i) {
...
function _i(t) {
  ...
  e.removeMatching(Ku), t && e.add("djs-cursor-" + t);
}
function ja() {
  _i(null);
}
...
function La(t, e) {
  ...
  function r(a) {
    ...
    if (!n.dragging && Gu(d) > Vu && (n.dragging = !0, u === 0 && Da(t), _i("grab")), n.dragging) {
...
function Na(t, e, n) {
  var i = this;
  this._config = T({}, Xu, t || {}), e.addListener(r);
  function r(o) {
...
var Yu = Math.sign || function(t) {
  return t >= 0 ? 1 : -1;
}, qr = { min: 0.2, max: 4 }, Wa = 10, Zu = 0.1, el = 0.75;
function Se(t, e, n) {
  t = t || {}, this._enabled = !1, this._canvas = n, this._container = n._container, this._handleWheel = Br(this._handleWheel, this), this._totalDelta = 0, this._scale = t.scale || el;
  var i = this;
...
Se.prototype.zoom = function(e, n) {
  var i = Ha(qr, Wa * 2);
  this._totalDelta += e, Math.abs(this._totalDelta) > Zu && (this._zoom(e, n, i), this._totalDelta = 0);
};
...
function Va(t, e, n, i) {
  t.on("create.end", 500, function(r) {
    ...
    if (s) {
      if (u === !1)
        return;
      L(u) ? e.select(u) : e.select(a.filter(al));
    }
...
function st(t, e) {
  ...
  t.on(["shape.added", "shape.changed"], hl, function(o) {
...
st.prototype.registerProvider = function(t, e) {
  e || (e = t, t = fl), this._eventBus.on("outline.getProviders", t, function(n) {
    n.providers.push(e);
  });
};
...
function Ja(t, e, n) {
  ...
  r && e.on("drag.start", function(s) {
    ...
    if (s instanceof MouseEvent)
      return a = Nt(s), c = document.elementFromPoint(a.x, a.y), yl(c);
  };
}
Ja.$inject = [
  "elementRegistry",
...
function Qa(t, e, n, i) {
  ...
  function u(y, v) {
    ...
    if (!o.active && (v || _l(C) > o.threshold)) {
      if (T(_, {
        x: ht(O.x + w.x),
        y: ht(O.y + w.y),
        dx: 0,
  ...
  function x(y, v, _, w) {
    ...
    w.trapClick ? M = h : M = l, y ? (b = Ft(y) || y, C = Nt(y), Wi(y), b.type === "dragstart" && Ze(b)) : (b = null, C = { x: 0, y: 0 }), O = s(C), v || (v = O), P = ml(b), o = T({
      prefix: _,
      data: R,
      payload: {},
      globalStart: C,
...
$e.prototype._cloneMarkers = function(t, e = "djs-dragger", n = t) {
  ...
  }), Cl(t) && bl.forEach(function(r) {
    if (k(t, r)) {
      var o = wl(t, r, i._canvas.getContainer());
      o && i._cloneMarker(n, t, o, r, e);
    }
  });
};
$e.prototype._cloneMarker = function(t, e, n, i, r = "djs-dragger") {
  var o = [n.id, r, xl.next()].join("-"), s = ee("marker#" + n.id, t);
...
function Cl(t) {
  return El.indexOf(t.nodeName) !== -1;
}
const bi = {
  __init__: ["previewSupport"],
  previewSupport: ["type", $e]
};
var Ol = 500, Tl = 1250, Rl = 1500, si = Math.round;
function kl(t) {
  return {
    x: t.x + si(t.width / 2),
    y: t.y + si(t.height / 2)
...
function Ya(t, e, n, i, r) {
  ...
  t.on("shape.move.start", Rl, function(a) {
    ...
    l.indexOf(u) === -1 && (l = [u]), l = Pl(l), T(c, {
      shapes: l,
      validatedShapes: l,
      shape: u
    });
  }), t.on("shape.move.start", Tl, function(a) {
    var c = a.context, u = c.validatedShapes, l;
    if (l = c.canExecute = o(u), !l)
      return !1;
  }), t.on("shape.move.move", Ol, function(a) {
...
function Za(t, e, n, i) {
  ...
  t.on("shape.move.start", es, function(c) {
    ...
    h.forEach(function(m) {
      ...
      e.addMarker(m, Ui);
    }), u.allDraggedElements = d, u.differentParents = Dl(l);
...
var Bl = /,?([a-z]),?/gi, os = parseFloat, $ = Math, Le = $.PI, me = $.min, _e = $.max, ss = $.pow, ze = $.abs, Wl = /([a-z])[\s,]*((-?\d*\.?\d*(?:e[-+]?\d+)?[\s]*,?[\s]*)+)/ig, zl = /(-?\d*\.?\d*(?:e[-+]?\d+)?)[\s]*,?[\s]*/ig, ai = Array.isArray || function(t) {
...
function Fl(t) {
  function e() {
    ...
    return Yr(r, i) ? (Ul(o, i), r[i]) : (o.length >= 1e3 && delete r[o.shift()], o.push(i), r[i] = t(...arguments), r[i]);
  }
  return e;
}
function Kl(t) {
  ...
  return ai(t) && ai(t[0]) && (i = hn(t)), i.length || String(t).replace(Wl, function(r, o, s) {
    var a = [], c = o.toLowerCase();
    for (s.replace(zl, function(u, l) {
      l && a.push(+l);
...
function Gl(t, e, n) {
  ...
  for (f = 0; f < a; f++)
    for (var m = 0; m < c; m++) {
      var g = u[f], E = u[f + 1], x = l[m], y = l[m + 1], v = ze(E.x - g.x) < 0.01 ? "y" : "x", _ = ze(y.x - x.x) < 0.01 ? "y" : "x", w = Vl(g.x, g.y, E.x, E.y, x.x, x.y, y.x, y.y), R;
      if (w) {
...
function ql(t) {
  ...
  if (e.abs)
    return ci(e.abs);
  if ((!ai(t) || !ai(t && t[0])) && (t = Kl(t)), !t || !t.length)
    return [["M", 0, 0]];
...
function ic(t, e, n, i, r, o, s, a, c, u) {
  var l = Le * 120 / 180, d = Le / 180 * (+r || 0), h = [], f, p = Fl(function(Fo, Ko, Hn) {
...
function fs(t) {
  ...
  if (e.curve)
    return ci(e.curve);
  for (var n = ql(t), i = { x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null }, r = function(f, p, m) {
    var g, E;
    if (!f)
...
function ed(t, e) {
  var n = nc(Ql(e, rc), Yl(t)), i = n[0], r = n[n.length - 1], o;
  return i ? i !== r ? i.segment2 !== r.segment2 ? (o = Jl(i.segment2, r.segment2) - 1, {
    point: t[o],
    bendpoint: !0,
    index: o
  }) : {
...
function oc(t, e) {
  var n = e[0], i = e[1], r = { x: i.x - n.x, y: i.y - n.y }, o = id([n.x, n.y], [r.x, r.y], [t.x, t.y]);
...
function sd(t, e, n, i) {
  var r = D("g");
  I(t, r);
  var o = 18, s = 6, a = 11, c = cd(e, n, i), u = s + a, l = D("rect");
  k(l, {
    x: -18 / 2,
    y: -6 / 2,
    width: o,
  ...
  return k(d, {
    ...
    width: c,
    height: u
  }), H(d).add("djs-hit"), I(r, d), Il(r, i === "v" ? 90 : 0), r;
}
function cc(t, e, n) {
  var i = D("g"), r = rr(e, n), o = ft(e, n);
  return I(t, i), sd(i, e, n, o), H(i).add(ac), H(i).add(o === "h" ? "horizontal" : "vertical"), he(i, r.x, r.y), i;
}
function cr(t) {
...
function fd(t) {
  for (var e = t.waypoints, n = e.reduce(function(u, l, d) {
    var h = e[d - 1];
    if (h) {
      var f = u[u.length - 1], p = f && f.endLength || 0, m = yd(h, l);
      u.push({
        start: h,
        end: l,
        startLength: p,
...
function eo(t, e, n, i, r, o) {
  this._injector = t, this.start = function(s, a, c, u) {
    ...
    m === tn ? (d ? h.splice(u, 0, E) : h[u] = E, g.bendpointMove = {
      insert: d,
      bendpointIndex: u
    }, h = this.cropWaypoints(l, h), o.updateWaypoints(l, gd(h), g)) : (m === et ? (g.docking = "source", li(a) && (g.docking = "target", g.newWaypoints = h.reverse())) : m === tt && (g.docking = "target", li(a) && (g.docking = "source", g.newWaypoints = h.reverse())), o.reconnect(l, f, p, E, g));
  }, this);
}
eo.$inject = [
  "injector",
...
var vd = "reconnectStart", md = "reconnectEnd", gs = "updateWaypoints", nn = "connect-ok", Kn = "connect-not-ok", ys = "connect-hover", vs = "djs-updating", ms = "djs-dragging", _s = 1100;
function dc(t, e, n, i) {
  this._injector = e;
  ...
  n.on("bendpoint.move.start", function(o) {
    ...
    r && (E.connectionStart && (x.connectionStart = E.connectionStart), E.connectionEnd && (x.connectionEnd = E.connectionEnd), d === vd ? li(s) ? (x.connectionEnd = x.connectionEnd || g, x.source = p, x.target = l || f, m = m.reverse()) : (x.connectionStart = x.connectionStart || g, x.source = l || f, x.target = p) : d === md ? li(s) ? (x.connectionStart = x.connectionStart || g, x.source = l || p, x.target = f, m = m.reverse()) : (x.connectionEnd = x.connectionEnd || g, x.source = f, x.target = l || p) : (x.noCropping = !0, x.noLayout = !0, m[c] = g), d === gs && (m = t.cropWaypoints(h, m)), x.waypoints = m, r.drawPreview(s, a, x)), he(u, o.x, o.y);
  }, this), n.on([
    "bendpoint.move.end",
...
function fc(t, e, n, i, r, o) {
  ...
  function u(d, h, f) {
    var p = d.newWaypoints, m = d.segmentStartIndex + h, g = p[m], E = d.segmentEndIndex + h, x = p[E], y = hc(d.axis), v = _d(f, g, x, y);
...
var Sd = Math.abs, As = Math.round, Fi = 10;
function gc(t) {
  function e(o, s) {
    if (L(o)) {
      for (var a = o.length; a--; ) if (Sd(o[a] - s) <= Fi)
        return o[a];
    } else {
      o = +o;
      var c = s % o;
...
Pe.prototype.drawPreview = function(t, e, n) {
  ...
  if (i || (i = t.connectionPreviewGfx = this.createConnectionPreviewGfx()), Ur(i), r || (r = t.getConnection = Od(function(m, g, E) {
...
Pe.prototype.createConnectionPreviewGfx = function() {
  ...
  return k(t, {
    pointerEvents: "none"
  }), H(t).add(Cd), I(this._canvas.getActiveLayer(), t), t;
};
...
function An(t, e) {
  ...
  t.on(["resize.start"], function(i) {
    ...
    if (!(i.originalEvent && Ee(i.originalEvent)) && !di(i)) {
      ...
      u.initialized || (u = n.addSnapTargetPoints(u, o, s, a), u.initialized = !0), Dd(a) && Oe(i, "x", i.x), Ld(a) && Oe(i, "y", i.y), e.snap(i, u);
    }
...
An.prototype.addSnapTargetPoints = function(t, e, n, i) {
  ...
  return A(r, function(o) {
    t.add("corner", wd(o)), t.add("corner", Ed(o));
...
var Nd = 7, Hd = 1e3;
function Ge(t) {
  this._canvas = t, this._asyncHide = wu(Br(this.hide, this), Hd);
}
Ge.$inject = ["canvas"];
Ge.prototype.snap = function(t, e) {
  ...
  A(r, function(s) {
    ...
    if (A(["x", "y"], function(u) {
      var l;
      o[u] || (l = e.snap(c, s, u, Nd), l !== void 0 && (o[u] = {
        value: l,
        originValue: l - a[u]
      }));
    }), o.x && o.y)
...
qt.prototype.create = function(t, e) {
  return e = T({}, e || {}), e.id || (e.id = t + "_" + this._uid++), $d(t, e);
};
...
}, vt.$inject = ["domainStoryIdFactory"], vt), qd = class {
  getId(e) {
...
const dr = [], Jd = {
  ...
  domainStoryIdFactory: ["type", qd]
}, Sc = {
  __depends__: [Jd],
  elementFactory: ["type", Gd]
};
var Qd = 0, Yd = {
  width: 150,
  height: 50
...
function nh(t, e, n) {
  for (var i = t.shift(), r = i, o; ; ) {
    if (o = th(r, n), o.width = r ? o.width : 0, r === " " || r === "" || o.width < Math.round(e) || r.length < 2)
      return ih(t, r, i, o);
    r = oh(r, o.width, e);
  }
}
...
function oh(t, e, n) {
  var i = Math.max(t.length * (n / e), 1), r = rh(t, i);
...
Si.prototype.layoutText = function(t, e) {
  var n = T({}, this._config.size, e.box), i = T({}, this._config.style, e.style), r = Zd(e.align || this._config.align), o = eh(e.padding !== void 0 ? e.padding : this._config.padding), s = e.fitBox || !1, a = ah(i), c = t.split(/\u00AD?\r?\n/), u = [], l = n.width - o.left - o.right, d = D("text");
  k(d, { x: 0, y: 0 }), k(d, i);
  var h = sh();
  for (I(h, d); c.length; )
    u.push(nh(c, l, d));
...
const Ac = {
  ...
  domainStoryTextRenderer: ["type", dh]
};
var _t;
let hh = (_t = class {
  constructor(e) {
...
const Eo = class Eo {
  constructor() {
    this.isDirtySubject = new Ru(!1), this.dirty$ = this.isDirtySubject.asObservable();
  }
  get dirty() {
...
const ot = {
  ...
  domainStoryElementRegistryService: ["type", hh],
...
class Q {
  ...
  set(e, n) {
    this.has(e) || this.entries.push(new fh(n, e));
  }
  add(e, n) {
    this.set(n, e);
  }
...
const Xt = {
  ...
  domainStoryIconSetImportExportService: ["type", gh]
};
var yh = 1e3;
function Jt(t, e) {
  var n = this;
  e = e || yh, t.on(["render.shape", "render.connection"], e, function(i, r) {
...
function xh(t, e) {
  return t.replace(bh, function(n, i) {
    return wh(n, i, e);
  });
}
const bh = /\{([^{}]+)}/g, Eh = /(?:(?:^|\.)(.+?)(?=\[|\.|$|\()|\[(['"])(.+?)\2])(\(\))?/g;
...
const kh = {
  ...
  execute(e) {
    return e.oldLabel = Tc(e.element), e.oldNumber = Sh(e.element), this.setText(e.element, e.newLabel, e.newNumber);
  }
  revert(e) {
...
oe.prototype.on = function(t, e, n, i, r, o) {
  if ((Z(e) || j(e)) && (o = r, r = i, i = n, n = e, e = null), Z(n) && (o = r, r = i, i = n, n = Ph), ie(r) && (o = r, r = !1), !Z(i))
...
function Hh(t, e, n) {
  return mr(n) && un(e) || mn(n) && un(t) && un(e) ? !1 : !(mn(n) && !un(e) && (vr(t) || Ih(t)));
}
var bt;
let Bh = (bt = class extends On {
  constructor(e) {
    super(e);
  }
  init() {
...
const Kh = new ku(), $h = [], $i = "#000000";
var Et;
let Vh = (Et = class extends Jt {
  constructor(e, n, i, r, o, s, a, c) {
    super(e, 2e3), this.styles = n, this.canvas = i, this.domainStoryTextRenderer = r, this.domainStoryNumberingRegistry = o, this.elementRegistryService = s, this.dirtyFlagService = a, this.iconDictionaryService = c, this.rendererId = Kh.next(), this.markers = {}, e.on("bendpoint.move.start", 200, function(u) {
  ...
  getIconSvg(e, n) {
    ...
    if (mh(e)) {
      let r;
      return _h(e) ? r = this.applyColorToCustomSvgIcon(i, e) : (r = e, i && i !== $i && document.dispatchEvent(new CustomEvent("errorColoringOnlySvg"))), '<svg viewBox="0 0 24 24" width="48" height="48" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><image width="24" height="24" xlink:href="' + r + '"/></svg>';
    } else
  ...
  renderActivityLabel(e, n) {
    const i = n.businessObject, r = n.waypoints, o = Uh(i.name), s = Fh(r, o), a = n.waypoints[s.selected], c = n.waypoints[s.selected + 1], u = Tn(a, c);
    let l = "left", d = 500, h = s.x;
    (u === 0 || u === 180) && (d = Math.abs(a.x - c.x), l = "center", h = (a.x + c.x) / 2 - Th(i.name));
    const f = {
      textAlign: l,
      width: d,
      height: 30,
  ...
  generateActivityNumber(e, n, i) {
    const r = Wh(), o = n.businessObject;
    r.use && (o.number = r.number), $h[o.number] = !0, i.x -= 26, i.y -= 16, o.number < 10 && (i.x += 3);
  ...
  renderExternalNumber(e, n) {
    if (n && n.source) {
      const i = n.businessObject, r = zh(n);
...
const Rn = {
  ...
  domainStoryRenderer: ["type", Vh]
};
function kc(t, e, n, i) {
  t.on("element.changed", function(r) {
    var o = r.element;
    (o.parent || o === e.getRootElement()) && (r.gfx = n.getGraphics(o)), r.gfx && t.fire(dl(o) + ".changed", r);
...
Ci.prototype.postExecute = function(t) {
  var e = t.hints || {};
  Xh(t.source, t.shape) || (e.connectionTarget === t.source ? this._modeling.connect(t.shape, t.source, t.connection) : this._modeling.connect(t.source, t.shape, t.connection));
};
function Xh(t, e) {
...
Vt(kn, qe);
kn.$inject = ["canvas"];
var Jh = qe.prototype.execute;
kn.prototype.execute = function(t) {
  var e = t.shape;
  return Yh(e), e.labelTarget = t.labelTarget, Jh.call(this, t);
};
var Qh = qe.prototype.revert;
kn.prototype.revert = function(t) {
  return t.shape.labelTarget = null, Qh.call(this, t);
};
function Yh(t) {
...
Xe.prototype.updateConnectionWaypoints = function(t, e, n, i, r, o, s) {
  ...
  A(t, function(u) {
    var l = u.source, d = u.target, h = of(u), f = jc(n), p = {};
...
B.prototype._create = function(t, e) {
  return Vd(e) ? e : this._elementFactory.create(t, e);
};
...
const af = {
  ...
  domainStoryRules: ["type", Bh]
};
var wt;
let uf = (wt = class extends B {
  constructor(e, n, i) {
...
ut.prototype.bindEvents = function(t, e) {
  ...
  }), n.on(i, hf, function(r) {
    this._active && (ff(r) || this.setActive(null));
  }, this);
};
function ff(t) {
...
po.prototype.getLastMoveEvent = function() {
  return this._lastMoveEvent || pf(0, 0);
};
function pf(t, e) {
...
var Vi = Math.abs, gf = Math.round, Ce = {
  x: "width",
  y: "height"
}, zc = "crosshair", Be = {
  n: "top",
...
function je(t, e, n, i, r, o, s) {
  ...
  o.registerTool("space", {
  ...
  }), n.on("spaceTool.move", yf, function(c) {
    ...
    if (u.initialized) {
      ...
      m[l] = gf(c["d" + l]), a.makeSpace(h, f, m, d, p), n.once("spaceTool.ended", function(g) {
...
je.prototype.init = function(t, e) {
  ...
  if (Vi(i) < 5)
    return !1;
  i < 0 && (i *= -1), ii(t) && (i *= -1);
  var o = tf(n, i), s = this._canvas.getRootElement();
...
je.prototype.calculateAdjustments = function(t, e, n, i) {
  ...
  A(t, function(h) {
    if (!(!h.parent || ne(h))) {
      ...
      if (mf(h) && (n > 0 && re(h)[e] > i || n < 0 && re(h)[e] < i)) {
        a.push(h);
        return;
      }
      if (n > 0 && f > i || n < 0 && p < i) {
...
var Gi = "djs-dragging", Ws = "djs-resizing", _f = 250, Jn = Math.max;
function Uc(t, e, n, i, r) {
  function o(s, a) {
    A(s, function(c) {
  ...
  t.on("spaceTool.selection.start", function(s) {
    ...
    c && Y(c);
  }), t.on("spaceTool.move", _f, function(s) {
...
var Kc = ".djs-palette-toggle", $c = ".entry", Ef = Kc + ", " + $c, br = "djs-palette-", wf = "shown", Er = "open", zs = "two-column", Sf = 1e3;
function G(t, e) {
...
G.prototype.registerProvider = function(t, e) {
  e || (e = t, t = Sf), this._eventBus.on("palette.getProviders", t, function(n) {
    n.providers.push(e);
  }), this._rebuild();
};
...
G.prototype._init = function() {
  ...
  n.appendChild(i), fe(n).add(br + wf), We.bind(i, Ef, "click", function(r) {
...
G.prototype._update = function() {
  ...
  Ou(t), A(e, function(n, i) {
    ...
    if (o.appendChild(a), !n.separator && (ye(a, "data-action", i), n.title && ye(a, "title", n.title), n.className && Af(a, n.className), n.imageUrl)) {
      var c = be("<img>");
...
var Tf = "drop-ok", Us = "drop-not-ok", Fs = "attach-ok", Ks = "new-parent", $s = "create", Rf = 2e3;
function Vc(t, e, n, i, r) {
  ...
  function s(c, u) {
    [Fs, Tf, Us, Ks].forEach(function(l) {
  ...
  n.on("create.init", function() {
    n.on("elements.changed", a), n.once(["create.cancel", "create.end"], Rf, function() {
...
function Gc(t, e, n, i, r) {
  ...
  e.on("create.move", kf, function(s) {
...
const Mf = {
  ...
  domainStoryPaletteProvider: ["type", Pf]
};
function qc(t, e, n, i) {
  function r(s, a) {
...
var If = 1100, jf = 900, qs = "connect-ok", Xs = "connect-not-ok";
function Xc(t, e, n) {
  ...
  }), e.on("connect.hover", jf, function(r) {
...
var Li, z, Jc, it, Js, Qc, Yc, Zc, yo, Sr, Ar, xn = {}, eu = [], Lf = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, vo = Array.isArray;
function Ue(t, e) {
...
function iu(t, e, n, i, r, o, s, a, c, u, l) {
  ...
  for (c = Nf(n, e, E, c, x), d = 0; d < x; d++) (f = n.__k[d]) != null && (h = f.__i === -1 ? xn : E[f.__i] || xn, f.__i = d, g = _o(t, f, h, r, o, s, a, c, u, l), p = f.__e, f.ref && h.ref != f.ref && (h.ref && xo(h.ref, null, f), l.push(f.ref, f.__c || p, f)), m == null && p != null && (m = p), 4 & f.__u || h.__k === f.__k ? c = ru(f, c, t) : typeof f.type == "function" && g !== void 0 ? c = g : p && (c = p.nextSibling), f.__u &= -7);
  return n.__e = m, c;
}
function Nf(t, e, n, i, r) {
  var o, s, a, c, u, l = n.length, d = l, h = 0;
  for (t.__k = new Array(r), o = 0; o < r; o++) (s = e[o]) != null && typeof s != "boolean" && typeof s != "function" ? (c = o + h, (s = t.__k[o] = typeof s == "string" || typeof s == "number" || typeof s == "bigint" || s.constructor == String ? ei(null, s, null, null, null) : vo(s) ? ei(Ni, { children: s }, null, null, null) : s.constructor === void 0 && s.__b > 0 ? ei(s.type, s.props, s.key, s.ref ? s.ref : null, s.__v) : s).__ = t, s.__b = t.__b + 1, a = null, (u = s.__i = Hf(s, n, c, d)) !== -1 && (d--, (a = n[u]) && (a.__u |= 2)), a == null || a.__v === null ? (u == -1 && h--, typeof s.type != "function" && (s.__u |= 4)) : u != c && (u == c - 1 ? h-- : u == c + 1 ? h++ : (u > c ? h-- : h++, s.__u |= 4))) : t.__k[o] = null;
...
function _o(t, e, n, i, r, o, s, a, c, u) {
  ...
  else o == null && e.__v == n.__v ? (e.__k = n.__k, e.__e = n.__e) : a = e.__e = Bf(n.__e, e, n, i, r, o, s, c, u);
...
var W = zf.bind(tu), zt, V, Xi, ta, bn = 0, cu = [], X = z, na = X.__b, ia = X.__r, ra = X.diffed, oa = X.__c, sa = X.unmount, aa = X.__;
function Bi(t, e) {
...
X.__b = function(t) {
  ...
  ra && ra(t);
  var e = t.__c;
  e && e.__H && (e.__H.__h.length && (cu.push(e) !== 1 && ta === X.requestAnimationFrame || ((ta = X.requestAnimationFrame) || Kf)(Ff)), e.__H.__.forEach(function(n) {
...
F.prototype.registerProvider = function(t, e, n) {
  n || (n = e, e = tp), this._eventBus.on("popupMenu.getProviders." + t, e, function(i) {
    i.providers.push(n);
  });
};
...
F.prototype.trigger = function(t, e, n = "click") {
  if (t.preventDefault(), !e) {
    let r = wn(t.delegateTarget || t.target, ".entry", !0), o = ye(r, ep);
...
Yt.$inject = ["eventBus"];
Yt.prototype.schedule = function(t, e = pp.next()) {
  this.cancel(e);
...
const mp = {
  ...
  domainStoryReplaceMenuProvider: ["type", vp]
};
function _p(t) {
  if (fu(t))
    return t;
...
const fu = (t) => /^#([A-Fa-f0-9]{3,4}){1,2}$/.test(t), xp = (t, e) => t.match(new RegExp(`.{${e}}`, "g")) ?? [], bp = (t) => parseInt(t.repeat(2 / t.length), 16), Ep = (t) => typeof t < "u" ? Math.round((t / 255 + Number.EPSILON) * 100) / 100 : 1, da = (t) => (t == null ? void 0 : t.startsWith("#")) && ((t == null ? void 0 : t.length) === 5 || (t == null ? void 0 : t.length) === 9), wp = (t) => {
  if (!fu(t))
    throw new Error("Invalid HEX");
  const e = Math.floor((t.length - 1) / 3), n = xp(t.slice(1), e), [i, r, o, s] = n.map(bp);
  return `rgba(${i},${r},${o},${Ep(s)})`;
};
var Ot;
let Sp = (Ot = class {
  ...
  getContextPadEntries(e) {
    ...
    da(n) && (n = wp(n)), document.dispatchEvent(
    ...
    return e.type.includes(S.WORKOBJECT) ? (i.set(...this.addDelete([e])), i.set(...this.addConnectWithActivity()), i.set(...this.addTextAnnotation()), i = new Map([...i, ...this.addActors()]), i = new Map([...i, ...this.addWorkObjects()]), i.set(...this.addChangeWorkObjectTypeMenu())) : e.type.includes(S.ACTOR) ? (i.set(...this.addDelete([e])), i.set(...this.addConnectWithActivity()), i.set(...this.addTextAnnotation()), i = new Map([...i, ...this.addWorkObjects()]), i.set(...this.addChangeActorTypeMenu())) : e.type.includes(S.GROUP) ? (i.set(...this.addDeleteGroupWithoutChildren()), i.set(...this.addTextAnnotation())) : e.type.includes(S.ACTIVITY) ? (i.set(...this.addDelete([e])), i.set(...this.addChangeDirection())) : e.type.includes(S.TEXTANNOTATION) ? i.set(...this.addDelete([e])) : e.type.includes(S.CONNECTION) && i.set(...this.addDelete([e])), Object.fromEntries(i);
  }
...
var Ap = "djs-element-hidden", Yn = ".entry", Cp = 1e3, ha = 8, Op = 300;
function q(t, e, n, i) {
...
q.prototype.registerProvider = function(t, e) {
  e || (e = t, t = Cp), this._eventBus.on("contextPad.getProviders", t, function(n) {
    n.providers.push(e);
  });
};
...
q.prototype._updateAndOpen = function(t) {
  ...
  A(e, function(r, o) {
    ...
    ye(a, "data-action", o), c = ee("[data-group=" + Zr(s) + "]", n), c || (c = be('<div class="group"></div>'), ye(c, "data-group", s), n.appendChild(c)), c.appendChild(a), r.className && Tp(a, r.className), r.title && ye(a, "title", r.title), r.imageUrl && (i = be("<img>"), ye(i, "src", r.imageUrl), i.style.width = "100%", i.style.height = "100%", a.appendChild(i));
...
q.prototype.getPad = function(t) {
  ...
  let e;
  return this.isOpen() && kp(this._current.target, t) ? e = this._current.html : e = this._createHtml(t), { html: e };
};
...
q.prototype._getPosition = function(t) {
  if (!L(t) && K(t)) {
    var e = this._canvas.viewbox(), n = Rp(t), i = n.x * e.scale - e.x * e.scale, r = n.y * e.scale - e.y * e.scale;
    return {
  ...
  const t = () => {
    if (this.isOpen()) {
      var e = this, n = this._current.target, i = L(n) ? n : [n], r = i.some(function(o) {
        return e._canvas.hasMarker(o, Ap);
      });
      r ? e.hide() : e.show();
    }
  };
...
const Pp = {
  ...
  contextPad: ["type", Pr],
  domainStoryContextPadProvider: ["type", Sp]
};
var gi = Math.max, yi = Math.min, Mp = 20;
function Ip(t, e, n) {
  var i = n.x, r = n.y, o = {
    x: t.x,
    y: t.y,
...
function Hp(t, e) {
  var n;
  if (t.length === void 0 ? n = we(t.children, Np) : n = t, n.length)
    return Lp(le(n), e);
}
var fa = 10;
function Ln(t, e, n, i) {
  ...
  function o(c, u) {
    ...
    c.delta = u, f = Ip(l, d, u), c.newBounds = jp(f, h), c.canExecute = r.canResize(c);
  }
  function s(c) {
...
Ln.prototype.computeMinResizeBox = function(t) {
  ...
  return i = t.minDimensions || {
    width: fa,
    height: fa
  }, r = Hp(e, t.childrenBoxPadding), Dp(n, e, i, r);
};
Ln.$inject = [
  "eventBus",
  "rules",
...
var pa = "djs-resizing", ga = "resize-not-ok", zp = 500;
function gu(t, e, n) {
  function i(o) {
  ...
  t.on("resize.move", zp, function(o) {
    i(o.context);
...
var ya = -6, va = 8, ma = 20, cn = "djs-resizer", Up = ["n", "w", "s", "e", "nw", "ne", "se", "sw"];
function Qe(t, e, n, i) {
...
Qe.prototype._createResizer = function(t, e, n, i) {
  var r = this._getResizersParent(), o = Fp(i), s = D("g");
  ...
  return k(c, {
    ...
    width: ma,
    height: ma
  }), H(c).add(cn + "-hit"), I(s, c), Ml(s, e, n), s;
};
...
Qe.prototype.addResizer = function(t) {
  var e = this;
  K(t) || !this._resize.canResize({ shape: t }) || A(Up, function(n) {
    e.createResizer(t, n);
  });
};
...
const Vp = {
  ...
  domainStoryLabelDictionaryService: ["type", $p]
...
const Gp = {
  ...
  revert(e) {
    const n = e.businessObject, i = e.element;
    return n.name = e.oldLabel, n.number = e.oldNumber, qp(
      e.oldNumbersWithIDs,
...
const Io = class Io {
  ...
  execute(e) {
    ...
    return e.children.forEach((i) => {
      vh(n, i), this.eventBus.fire("element.changed", { element: i });
...
const Jp = {
  ...
  domainStoryUpdateHandler: ["type", Xp]
};
function Nn() {
}
...
function ve(t, e, n, i, r, o, s, a) {
  this._canvas = t, this._create = e, this._clipboard = n, this._elementFactory = i, this._eventBus = r, this._modeling = o, this._mouse = s, this._rules = a, r.on("copyPaste.copyElement", function(c) {
    ...
    h && (u.parent = l.parent.id), Yp(l) && (u.priority = 2, u.host = l.host.id), K(l) && (u.priority = 3, u.source = l.source.id, u.target = l.target.id, u.waypoints = Zp(l)), ne(l) && (u.priority = 4, u.labelTarget = l.labelTarget.id), A(["x", "y", "width", "height"], function(f) {
      j(l[f]) && (u[f] = l[f]);
...
let ng = (kt = class {
  constructor(e, n) {
    this.domainStoryPropertyCopy = e, this.references = {}, n.on("copyPaste.copyElement", tg, function(i) {
      ...
      o.businessObject = this.domainStoryPropertyCopy.copyElement(
        s,
        a
      ), this.resolveReferences(o, r), wa(o, a, ["name"]), ig(o, "oldBusinessObject");
    });
  }
...
const rg = ["incoming", "outgoing"], jo = class jo {
  constructor(e) {
...
const cg = {
  ...
  domainStoryEditorActions: ["type", ag]
};
var Mt;
let ug = (Mt = class {
  constructor(e, n) {
...
const lg = {
  __depends__: [Gr, Pa, cg],
  __init__: ["domainStoryKeyboardBindings"],
  domainStoryKeyboardBindings: ["type", ug]
}, Do = class Do {
  constructor(e, n, i) {
...
const fg = {
  ...
  domainStoryNumberingUi: ["type", hg]
};
class pg {
  constructor(e, n) {
...
const yg = {
  ...
  domainStoryExportService: ["type", gg]
};
class vg {
...
function _g(t) {
  return W`
        <div
            ...
            "
        >
            <img src=${mg} alt="Egon.io Logo" style="height: 32px; width: auto;" />
...
let xg = (Dt = class {
  constructor(e, n, i, r, o, s) {
    this.eventBus = e, this.canvas = n, this.elementRegistry = i, this.elementFactory = r, this.iconDictionaryService = o, this.iconSetImportExportService = s, this.elements = [], this.groupElements = [], this.importRepairService = new vg();
  }
  /**
  ...
  import(e) {
    ...
    i.forEach(function(l) {
      bg(l) ? a.push(l) : Qi(l) ? c.push(l) : u.push(l);
...
const Eg = {
  ...
  domainStoryImportService: ["type", xg]
}, wg = [
  Pa,
  Gr,
  qu,
