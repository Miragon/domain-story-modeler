...
- **Apps**:
  - vscode-plugin (VS Code extension) - built with Webpack
  - egn-webview (TypeScript webview) - built with Vite and `egon-core`
- **Libs**: modeler-core (host-independent behavior and ports), modeler-shared (host protocol), modeler-types (browser-safe EGN types/defaults)
...
- **Build Output**: 
  ...
  - Extension: dist/apps/vscode-plugin/ (self-contained bundle, ready for vsce packaging)
